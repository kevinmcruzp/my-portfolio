...
export default async function Portfolio ({
    ...
    return (
        ...
        ">
            ...
            <Card tags={['Nextjs','Tailwind']} title={dictionary.about.title} description={dictionary.about.description} img={Feedback} alt="Feedback" href="https://nlw-return-react.vercel.app/" />  
        </section>
    )
}